...
export default {
    ...
    methods: {
         ...
         */
        setMapTypeId(type) {
            this.map.setMapTypeId(window.naver.maps.Position[type]);
            return this;
        },
        /**
        ...
        loadNaverMapsComponents() {
            ...
            this.map = new window.naver.maps.Map(this.domId, {...settings, ...this.mapOptions});
            if (this.zoomControlOptions && this.zoomControlOptions.position) this.setOptions({zoomControlOptions: {position: window.naver.maps.Position[this.zoomControlOptions.position]}});
